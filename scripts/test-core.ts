...
async function runTest(label: string, input: BookFormInput) {
  ...
  assert(imgPrompt1.startsWith(ART_STYLE_PREFIX), 'page 1 image prompt starts with art style prefix')
  assert(imgPrompt10.startsWith(ART_STYLE_PREFIX), 'page 10 image prompt starts with art style prefix')
